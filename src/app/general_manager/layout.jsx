...
const MENU_ITEMS = {
  general_manager: [
    ...
    },
    {
      ...
      icon: faLock,
      path: "/general-manager/change-password",
      screenName: "تغيير كلمة المرور",
      subItems: [],
    },
    {
      name: "المتابعة والمراقبة",
      icon: faEye,
      subItems: [
      ...
      subItems: [
        {
          ...
          path: "/general-manager/reports/daily-performance",
          screenName: "تقرير الأداء اليومي",
        },
        {
          name: "تقرير الأداء الشهري",
          path: "/general-manager/reports/monthly-performance",
          screenName: "تقرير الأداء الشهري",
        },
        {
          name: "تقرير المتابعة العامة",
          path: "/general-manager/reports/general-monitoring",
          screenName: "تقرير المتابعة العامة",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      subItems: [
        ...
        { name: "تحليل البيانات", path: "/general-manager/analytics/data-analysis", screenName: "تحليل البيانات" },
        {
          ...
          path: "/general-manager/analytics/kpi",
          screenName: "مؤشرات الأداء الرئيسية",
        },
      ],
    },
    {
      name: "الجدولة والتخطيط",
      icon: faCalendarAlt,
      subItems: [
        { name: "جدولة المهام", path: "/general-manager/scheduling/tasks", screenName: "جدولة المهام" },
        {
          name: "التخطيط الاستراتيجي",
          path: "/general-manager/scheduling/strategic",
          screenName: "التخطيط الاستراتيجي",
        },
