...
export default function DeletedRecords() {
  ...
  const loadData = useCallback(async () => {
    setIsLoading(true);
    try {
      const response = await fetch('/api/meter-data-4');
      if (!response.ok) {
  ...
  return (
    <div className="container">
                ...
                <thead>
                  <tr>
                    {[
                      ...
                      'القائم بالإضافة', 'القائم بالتعديل', 'القائم بالحذف', 'الفرع التابع له',
                    ].map((header, index) => (
      ...
      <div id="printableArea" style={{ display: 'none' }}>
        ...
        <h2 style={{ textAlign: 'center', marginTop: '150px', color: 'var(--primary)', fontWeight: '600' }}>تقرير المحذوفات فحص أحادي الوجه</h2>
